...
pdf("./fig/bias_decomp_2_groups.pdf", height = 5, width = 7)
plots[[1]]
dev.off()

pdf("./fig/bias_decomp_2_groups_orig.pdf", height = 5, width = 7)
plots[[2]]
dev.off()

pdf("./fig/bias_decomp_2_groups_boot.pdf", height = 5, width = 7)
plots[[3]]
dev.off()
